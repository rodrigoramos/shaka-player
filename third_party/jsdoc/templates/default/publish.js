...
function buildNav(members) {
    ...
    if (members.classes.length) {
        members.classes.forEach(function(c) {
            if ( !hasOwnProp.call(seen, c.longname) ) {
                var showLevel = (c.visibility ? '0' : '1');
                var classNames = 'visibility-' + (c.visibility || '') +
                                 ' show' + showLevel;
                classNav += '<li class="' + classNames + '">' + linkto(c.longname, c.longname) + '</li>';
            }
    ...
    if (members.interfaces.length) {
        ...
        members.interfaces.forEach(function(i) {
            var showLevel = (i.visibility ? '0' : '1');
            var classNames = 'visibility-' + (i.visibility || '') +
                             ' show' + showLevel;
            nav += '<li class="' + classNames + '">' + linkto(i.longname, i.longname) + '</li>';
        });
        nav += '</ul>';
    }
    ...
    if (members.events.length) {
        ...
        members.events.forEach(function(e) {
            var showLevel = (e.visibility ? '0' : '1');
            var classNames = 'visibility-' + (e.visibility || '') +
                             ' show' + showLevel;
            if ( !hasOwnProp.call(seen, e.longname) ) {
                nav += '<li class="' + classNames + '">' + linkto(e.longname, e.longname) + '</li>';
            }
            seen[e.longname] = true;
        });
    ...
    if (members.globals.length) {
        members.globals.forEach(function(g) {
            if ( g.kind !== 'typedef' && !hasOwnProp.call(seen, g.longname) ) {
                globalNav += '<li>' + linkto(g.longname, g.longname) + '</li>';
            }
