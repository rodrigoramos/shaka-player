...
var closureTags = exports.closureTags = {
    ...
    namespace: {
        // This is a different use of @namespace compared to standard JSDoc.
        // The goal here is to treat this like a class and show it in the list
        // of classes, but not show a signature for a non-existent constructor.
        onTagged: function(doclet, tag) {
            doclet.addTag('kind', 'class');
            setDocletNameToValue(doclet, tag);
            doclet.noConstructor = true;
        }
    },
