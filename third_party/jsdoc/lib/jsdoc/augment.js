...
exports.addImplemented = function(docs) {
    ...
    Object.keys(interfaces).forEach(function(ifaceName) {
        ...
        if (hasOwnProp.call(docMap, iface.longname)) {
            docMap[iface.longname].forEach(function(doc) {
        ...
        owner.forEach(function(klass) {
            ...
            klass.implements.forEach(function(impl) {
                ...
                for (var i = 0, len = members.length; i < len; i++) {
                    ...
                    // inherit docs from the interface if not given in the implementation
                    member.description = member.description || interfaceMember.description;
                    member.params = member.params || interfaceMember.params;
                    member.returns = member.returns || interfaceMember.returns;
                    member.fires = member.fires || interfaceMember.fires;
                }
            });
        });
    });
