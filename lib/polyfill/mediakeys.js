...
goog.require('shaka.polyfill.PatchedMediaKeys.ms');
...
shaka.polyfill.MediaKeys.install = function() {
  ...
  } else if (HTMLMediaElement.prototype.msSetMediaKeys) {
    shaka.log.info('Using prefixed Microsoft EME.');
    shaka.polyfill.PatchedMediaKeys.ms.install();
  } else {
