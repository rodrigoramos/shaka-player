...
shaka.polyfill.PatchedMediaKeys.ms.MediaKeys.prototype.createSession =
  ...
  // TODO: Remove this - Para criar erro
  var a = shaka.util.Uint8ArrayUtils.fromString('Rodrigo');
  var session = this.msMediaKey_.createSession('video/mp4', this.initData_, a);
