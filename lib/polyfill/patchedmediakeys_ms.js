...
/**
  * Closure definition for MS-specific MediaKeys
  *
  * @typedef {Object}
  */
var MSMediaKeys;
...
/**
  * Closure definition for MS-specific MediaKeySession
  *
  * @typedef {Object}
  */
...
/**
  * Closure definition for MS-specific MediaKeyMessageEvent
  *
  * @typedef {Object}
  */
...
/**
  * Microsoft's specific-version of setMediaKeys
  *
...
shaka.polyfill.PatchedMediaKeys.ms.MediaKeys.prototype.createSession =
  ...
  // Ignore generateRequest - it's not required anymore
  window.MSMediaKeySession.prototype.generateRequest = function() {
    return Promise.resolve();
  };
