 ...
 *
 * @fileoverview Implements a WebM Cues element parser.
 */
...
/**
 * Creates a WebmSegmentIndexParser.
 *
 * @constructor
 * @struct
 */
...
shaka.media.WebmSegmentIndexParser.prototype.parse = function(
  ...
  try {
    references = this.parseInternal_(cuesData, initData, url);
  } catch (exception) {
...
shaka.media.WebmSegmentIndexParser.prototype.parseCues_ = function(
    cuesElement, segmentOffset, timecodeScale, url) {
  var references = [];
